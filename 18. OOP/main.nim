...
import Animal # import class from outside file (private variables can't be accesed from inside this file)
...
type
    ...
    Person = ref object of RootObj # create an object (ineritance), this is the correct way to do OOP
